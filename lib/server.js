...
function buildServerProposalMarkup (strings) {
  ...
  return {
    ...
    <section id="server-proposal" role="dialog" aria-modal="true" aria-labelledby="server-proposal-title" hidden>
...
function buildLocalePage (indexHtmlTemplate, locale, canonicalPath) {
  ...
  const footerPoweredBy = strings.footerPoweredBy
    .replace('{link}', '<a href="https://github.com/Cryptkeeper/Minetrack">Minetrack</a>')
